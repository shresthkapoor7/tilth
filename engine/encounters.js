...
export class Encounters{
 constructor({actors=ACTORS,mover=advance,onProvoked=()=>{},onFeedback=()=>{},onDefeated=()=>{}}={}){this.actors=actors.map(a=>({...a,maxHp:a.hp,home:{x:a.x,y:a.y},direction:'down',hostile:false,attack:null,ready:0,downUntil:0,peaceAt:0,nextRoam:0,walk:false,bubble:'',bubbleUntil:0,revision:0}));this.mover=mover;this.onProvoked=onProvoked;this.onFeedback=onFeedback;this.onDefeated=onDefeated;this.time=0;this.hp=280;this.maxHp=280;this.swing=null;this.invulnerable=0;this.guardUntil=0;this.potionReady=0;this.floats=[]}
